...
const DocketMedia = () => {
  ...
  const [showExecuteDescriptionModal, setShowExecuteDescriptionModal] = useState(false);

  const [showVisualElementsModal, setShowVisualElementsModal] = useState(false);
  ...
  return (
    <div className="docket-container">
      ...
      {executeDescription && (
        <div
          className="docket-hover-wrapper"
          style={{
            marginTop: '8px',
        ...
        >
          ...
          <div className="docket-hover-popup">
            <div
              style={{
                padding: '14px',
                maxWidth: '450px',
